...
Revision ID: 0468_edit_limit_emails
Revises: 0467_add_limit_emails
...
revision = "0468_add_limit_emails"
down_revision = "0467_add_limit_emails"
...
near_annual_limit = "\n".join(
    [
        ...
        "Le service Notification GC comporte des limites annuelles et quotidiennes. Ce message concerne votre limite annuelle.",
        "",
        "((service_name)) a envoyé ((count_fr)) ((message_type_fr)) et sa limite d’envoi est fixée à ((message_limit_en)) ((message_type_fr)) par exercice financier.",
