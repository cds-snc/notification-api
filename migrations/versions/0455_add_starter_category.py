...
category_data = [
    ...
    ("Reminder", "Rappel", "Appointments and deadlines", "Rendez-vous et échéances", "medium", "medium"),
    ("Request", "Demande", "Request: Follow up and next steps", "Suivis et prochaines étapes", "medium", "medium"),
    ("Status update", "Mise à jour du statut", "Changes and progress", "Changements et progrès", "low", "low"),
    ("Test", "Test", "Practice messages", "Messages de pratique", "low", "low"),
]
