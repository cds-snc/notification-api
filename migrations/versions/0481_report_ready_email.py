...
report_download_content =report_download_content = "\n".join(
    [
        ...
        "Hello ((name)),",
        "",
        "You requested a report of ''((report_name_en))''.",
        "",
        ...
        "Bonjour ((name)),",
        "",
        "Vous avez demandé un rapport de «((report_name_fr))».",
        "",
        "Ce rapport est maintenant prêt à être téléchargé. Pour y accéder, consultez [les rapports de livraison](((hyperlink_to_page_fr))) de ((service_name)).",
        "",
