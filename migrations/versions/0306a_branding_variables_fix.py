...
def upgrade():
    ...
    op.execute(
        "UPDATE email_branding SET brand_type = 'custom_logo_with_background_colour' WHERE brand_type = 'custom_logo_with_banner'"
    )
...
def downgrade():
    ...
    op.execute(
        "UPDATE email_branding SET brand_type = 'custom_logo_with_banner' WHERE brand_type = 'custom_logo_with_background_colour'"
    )
