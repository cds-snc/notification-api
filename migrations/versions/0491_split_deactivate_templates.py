...
def _new_service_suspended_content():
    return "\n".join(
        [
            ...
            "",
            "[[en]]",
            "We’ve suspended ((service name)) because you’re now the only team member for that service. The other team member deactivated their account. GC Notify requires at least 2 team members per service.",
            "",
            ...
            "",
            "[[fr]]",
            "Nous avons suspendu ((service name)) parce que vous êtes maintenant le seul membre d’équipe pour ce service. L’autre membre d’équipe a désactivé son compte. Notification GC exige au moins 2 membres d’équipe par service.",
            "",
            "Pour lever la suspension, nous avons besoin de :",
            "",
            "- Le nom du service suspendu",
            "- Le nom d’un nouveau membre d’équipe qui a déjà un compte Notification GC.",
            "",
            "Lorsque vous disposez de ces renseignements, [contactez-nous](https://notification.canada.ca/fr/contact).",
            "",
...
def _new_user_deactivated_content():
    ...
    return "\n".join(
        [
            ...
            "",
            "Si vous ne souhaitez pas désactiver votre compte, [contactez-nous](https://notification.canada.ca/fr/contact) immédiatement.",
            "",
            "L’équipe Notification GC",
            "[[/fr]]",
        ]
