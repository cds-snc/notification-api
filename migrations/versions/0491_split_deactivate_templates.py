...
def _new_service_suspended_content():
    return "\n".join(
        [
            ...
            "",
            "[[en]]",
            "We’ve suspended ((service_name)) because you’re now the only team member for that service. The other team member deactivated their account. GC Notify requires at least 2 team members per service.",
            "",
            ...
            "",
            "[[fr]]",
            "Nous avons suspendu ((service_name)) parce que vous êtes maintenant le seul membre d’équipe pour ce service. L’autre membre d’équipe a désactivé son compte. Notification GC exige au moins 2 membres d’équipe par service.",
            "",
