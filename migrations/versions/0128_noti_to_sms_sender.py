...
def upgrade():
    op.create_index(
        op.f("ix_service_letter_contacts_service_id"),
    ...
    op.create_index(
        op.f("ix_service_sms_senders_service_id"),
        "service_sms_senders",
        ["service_id"],
        unique=False,
    )
    op.execute("ALTER TABLE templates_history ALTER COLUMN template_type TYPE template_type USING template_type::template_type")
...
def downgrade():
    ...
    op.create_index(
        "ix_service_letter_contact_service_id",
        "service_letter_contacts",
        ["service_id"],
        unique=False,
    )
