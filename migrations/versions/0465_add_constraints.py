...
def upgrade():
    op.execute("DROP INDEX IF EXISTS ix_service_id_notification_type")
    op.create_index("ix_service_id_notification_type", "annual_limits_data", ["time_period", "service_id", "notification_type"])
...
def downgrade():
    ...
    op.drop_index("ix_service_id_notification_type", "annual_limits_data")
