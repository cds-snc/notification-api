...
near_content = "\n".join(
    [
        ...
        "",
        "**((service_name)) peut encore envoyer ((remaining_fr)) messages d'ici à ce que votre limite de ((message_type_fr)) soit réinitialisée à ((limit_reset_time_et_24hr)), heure de l'Est.** Comparez les [heures officielles à travers le Canada](https://nrc.canada.ca/en/web-clock/).",
        "",
