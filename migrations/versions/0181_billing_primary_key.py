...
def upgrade():
    op.alter_column("ft_billing", "service_id", existing_type=postgresql.UUID(), nullable=False)
...
def downgrade():
    op.alter_column("ft_billing", "service_id", existing_type=postgresql.UUID(), nullable=True)
