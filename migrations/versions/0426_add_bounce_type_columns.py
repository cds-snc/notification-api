...
def upgrade():
    ...
    feedback_subtypes = sa.Enum("general", "no-email", "suppressed", "on-account-suppression-list", "mailbox-full", "message-too-large", "content-rejected", "attachment-rejected", name="notification_feedback_subtypes")
