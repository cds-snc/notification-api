...
@pytest.mark.parametrize('date, expected_date', [
    (datetime(2016, 1, 15, 4, 30), datetime(2016, 1, 14, 5, 0)),
    (datetime(2016, 1, 15, 5, 00), datetime(2016, 1, 15, 5, 0)),
    (datetime(2016, 6, 15, 4, 0), datetime(2016, 6, 15, 4, 0)),
    (datetime(2016, 9, 15, 3, 59), datetime(2016, 9, 14, 4, 0)),
    # works for both dates and datetimes
...
@pytest.mark.parametrize('date, expected_date', [
    (datetime(2016, 1, 15, 5, 30), datetime(2016, 1, 14, 5, 0)),
    (datetime(2016, 7, 15, 5, 0), datetime(2016, 7, 14, 4, 0)),
    (datetime(2016, 8, 23, 4, 59), datetime(2016, 8, 22, 4, 0)),
])
...
@pytest.mark.parametrize('current_time, arg, expected_datetime', [
    # winter
    ('2018-01-11 04:59', 1, datetime(2018, 1, 9, 5, 0)),
    ('2018-01-11 05:00', 1, datetime(2018, 1, 10, 5, 0)),
    ...
    # zero days ago
    ('2018-01-11 05:00', 0, datetime(2018, 1, 11, 5, 0)),
