...
class TestResigning:
    def test_resign_callbacks_FF_true(self, client, sample_service):
        ...
        with set_config(client.application, "FF_RESIGN_TASKS_ENABLED", True):
            resign_service_callbacks_task()
    ...
    def test_resign_callbacks_FF_default(self, sample_service):
        from app import signer_bearer_token
    ...
    def test_resign_api_keys_FF_default(self, sample_service):
        from app import signer_api_key
    ...
    def test_resign_inbound_sms_FF_default(self, sample_service):
        from app import signer_inbound_sms
