...
from app.celery.monthly_tasks import resign_api_keys_task, resign_service_callbacks_task
from app.models import ApiKey, ServiceCallbackApi
from tests.app.db import create_api_key, create_service_callback_api
