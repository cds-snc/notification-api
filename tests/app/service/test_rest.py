...
class TestServiceTemplateUsage:
    def test_get_specific_template_usage(self, admin_request, notify_db, notify_db_session):
        service = create_service(service_name="ABCDEF", smtp_user="foo")
        ...
        resp = admin_request.get('service.get_specific_template_usage', service_id=service.id, template_id=template.id)
    ...
    def test_get_specific_template_usage_with_start_date(self, admin_request, notify_db, notify_db_session):
        ...
        resp = admin_request.get(
            'service.get_specific_template_usage',
            service_id=service.id,
