...
class TestGetServiceWhitelist:
    ...
    def test_get_whitelist_returns_data(self, client, sample_service_whitelist):
    ...
    def test_get_whitelist_separates_emails_and_phones(self, client, sample_service):
    ...
    def test_get_whitelist_404s_with_unknown_service_id(self, client):
    ...
    def test_get_whitelist_returns_no_data(self, client, sample_service):
...
class TestUpdateServiceWhitelist:
    ...
    def test_update_whitelist_replaces_old_whitelist(self, client, sample_service_whitelist):
        data = {
    ...
    def test_update_whitelist_doesnt_remove_old_whitelist_if_error(self, client, sample_service_whitelist):
