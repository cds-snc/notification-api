from common import rows_to_csv, job_line, s3upload, set_metadata_on_csv_upload, get_csv_location
...
def test_admin_sms_csv():
    print("test_admin_sms_csv... ", end="", flush=True)

    data = rows_to_csv([["phone number", "name"], *job_line(SMS_TO, 1)])
