...
class Config(object):
    ...
    AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME = os.getenv("AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME", "PROD - Mailing List - Growth")
...
class Development(Config):
    ...
    AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME = os.getenv("AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME", "DEV - Mailing List - Growth")
    AIRTABLE_CURRENT_NEWSLETTER_TEMPLATES_TABLE_NAME = os.getenv(
...
class Staging(Production):
    ...
    AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME = os.getenv("AIRTABLE_NEWSLETTER_GROWTH_TABLE_NAME", "STAGING - Mailing List - Growth")
    AIRTABLE_CURRENT_NEWSLETTER_TEMPLATES_TABLE_NAME = os.getenv(
