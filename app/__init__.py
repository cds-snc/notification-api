...
flask_elasticache_queue = FlaskRedis(config_prefix="ELASTICACHE_QUEUE")
...
def create_app(application, config=None):
    ...
    flask_elasticache_queue.init_app(application)
    redis_store.init_app(application)
    bounce_rate_client.init_app(application)

    sms_bulk_publish.init_app(flask_elasticache_queue, metrics_logger)
    sms_normal_publish.init_app(flask_elasticache_queue, metrics_logger)
    sms_priority_publish.init_app(flask_elasticache_queue, metrics_logger)
    email_bulk_publish.init_app(flask_elasticache_queue, metrics_logger)
    email_normal_publish.init_app(flask_elasticache_queue, metrics_logger)
    email_priority_publish.init_app(flask_elasticache_queue, metrics_logger)

    sms_bulk.init_app(flask_elasticache_queue, metrics_logger)
    sms_normal.init_app(flask_elasticache_queue, metrics_logger)
    sms_priority.init_app(flask_elasticache_queue, metrics_logger)
    email_bulk.init_app(flask_elasticache_queue, metrics_logger)
    email_normal.init_app(flask_elasticache_queue, metrics_logger)
    email_priority.init_app(flask_elasticache_queue, metrics_logger)
