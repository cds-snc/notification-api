    ...
    try:
        ...
        if notification_status != NOTIFICATION_DELIVERED:
            ...
            if current_app.config["FF_ANNUAL_LIMIT"]:
                increment_notifications_failed(service_id=notification.service_id, notification_type=SMS_TYPE)
                current_app.logger.info(
            ...
            # TODO FF_ANNUAL_LIMIT removal
            if current_app.config["FF_ANNUAL_LIMIT"]:
                increment_notifications_delivered(service_id=notification.service_id, notification_type=SMS_TYPE)
                current_app.logger.info(
