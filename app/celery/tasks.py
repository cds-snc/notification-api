    ...
    for signed_notification in signed_notifications:
        ...
        notification: VerifiedNotification = {
            **_notification,  # type: ignore
            ...
            "service": service,
            "key_type": _notification["key_type"] if "key_type" in _notification else KEY_TYPE_NORMAL,
            ...
            "job_id": _notification["job_id"] if "job_id" in _notification else None,
            "job_row_number": _notification["row_number"] if "row_number" in _notification else None,
        }
