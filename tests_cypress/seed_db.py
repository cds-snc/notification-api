...
SQLALCHEMY_DATABASE_URI =  os.getenv("SQLALCHEMY_DATABASE_URI") #"postgresql://postgres:postgres@localhost:5432/test_notification_api"
...
with engine.connect() as conn:
    with conn.begin():
        ...
        insert_api_keys = """
            ...
            VALUES
            (E'076fc5ba-8578-44d6-8b69-122ac3a7b206',E'CYPRESS_TEST_KEY',E'IjY3YTViZmU4LWMxNjktNDQ0NS04OGVjLWRkNWExZDA3NjFmYSI.wLt-AQOYG3vgab_qP1p0Djw_r-8',E'4049c2d0-0cab-455c-8f4c-f356dff51811',NULL,E'2023-07-10 16:44:13.025984',E'6af522d0-2915-4e52-83a3-3690455a5fe6',NULL,1,E'test'),
