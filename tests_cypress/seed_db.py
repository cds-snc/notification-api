...
with engine.connect() as conn:
    with conn.begin():        
        ...
        insert_templates = """
            ...
            VALUES
            (E'136e951e-05c8-4db4-bc50-fe122d72fcaa',E'SMOKE_TEST_EMAIL',E'email',E'2023-05-24 13:31:40.907915',NULL,E'# This is a smoke test from Cypress\n\nSMOKE_TEST_EMAIL',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'SMOKE_TEST_EMAIL',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'258d8617-da88-4faa-ad28-46cc69f5a458',E'VARIABLES_EMAIL_TEMPLATE_ID',E'email',E'2023-07-10 16:38:43.913184',NULL,E'Hi ((name))\n\n((has_stuff??You have stuff!))',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'TESTING',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'2d52d997-42d3-4ac0-a597-7afc94d4339a',E'SMOKE_TEST_EMAIL_LINK',E'email',E'2023-05-24 13:32:49.286647',NULL,E'# This is a smoke test from Cypress\n\nSMOKE_TEST_EMAIL_LINK\n\n((link_to_file))',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'SMOKE_TEST_EMAIL_LINK',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'48207d93-144d-4ebb-92c5-99ff1f1baead',E'SMOKE_TEST_EMAIL_BULK',E'email',E'2023-05-24 13:32:24.912515',NULL,E'# This is a smoke test from Cypress\n\nSMOKE_TEST_EMAIL_BULK',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'SMOKE_TEST_EMAIL_BULK',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'58db03d6-a9d8-4482-8621-26f473f3980a',E'SMOKE_TEST_EMAIL_ATTACH',E'email',E'2023-05-24 13:32:03.754124',NULL,E'# This is a smoke test from Cypress\n\nSMOKE_TEST_EMAIL_ATTACH',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'SMOKE_TEST_EMAIL_ATTACH',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'5945e2f0-3e37-4813-9a60-e0665e02e9c8',E'SMOKE_TEST_SMS',E'sms',E'2023-05-24 13:33:20.936811',NULL,E'SMOKE_TEST_SMS',E'4049c2d0-0cab-455c-8f4c-f356dff51811',NULL,E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL),
            (E'b4692883-4182-4a23-b1b9-7b9df66a66e8',E'SIMPLE_EMAIL_TEMPLATE_ID',E'email',E'2023-07-10 16:33:10.288618',NULL,E'TESTING',E'4049c2d0-0cab-455c-8f4c-f356dff51811',E'TESTING',E'0840b12a-8139-4627-b27a-58872913ae14',1,FALSE,E'bulk',NULL,FALSE,NULL);
        """
